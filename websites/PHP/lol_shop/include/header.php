...
$pageTitle = 'LOL&acute;s Online Shop';
...
<body background="images/page-bg.jpg" style=" background-size:contain; background-repeat:no-repeat; background-color:#0A0616; b margin:0; padding:0">