...
$sql = "SELECT pd_id, pd_name, pd_price, pd_thumbnail, pd_qty, c.cat_id
		...
		ORDER BY pd_name";
$result     = dbQuery(getPagingQuery($sql, $productsPerPage,'page'));
$pagingLink = getPagingLink($sql, $productsPerPage, "c=$catId",'page');
...
?>
<table width="100%" border="0" cellspacing="0" cellpadding="20" style="color:#000; padding:20px">
<?php 
if ($numProduct > 0 ) {
