...
//
//define('WEB_ROOT', 'http://127.0.0.1:81/'.$webRoot);
//define('SRV_ROOT', $srvRoot);

define('WEB_ROOT', 'http://localhost:81/plaincart/');
define('SRV_ROOT', 'http://localhost:81/plaincart/');
...
define('NEWS_IMAGE_DIR',  'images/news/');
...
// maximum width for news image
define('MAX_NEWS_IMAGE_WIDTH', 500);
